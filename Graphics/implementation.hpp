...
/*
        ...
        colors[ImGuiCol_MenuBarBg]              = ImVec4(0.32f, 0.32f, 0.63f, 0.87f);
        ...
        im_style.FrameBorderSize                 = 1.f;
        im_style.WindowRounding                  = 0.f;
        im_style.ScrollbarRounding               = 4.f;
        im_style.WindowTitleAlign                = { 0.5f, 0.5f };
    }
